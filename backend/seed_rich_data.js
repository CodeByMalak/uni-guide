...
const richUniversities = [
  ...
  },
  {
    ...
    description: "CECOS University of IT and Emerging Sciences is a premier private sector university in Peshawar. It provides leading technology, software, civil engineering, and biotech streams.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1541339907198-e08756ebafe3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    fees: "PKR 30,000 - 50,000 / sem",
    lastDate: "Aug 18, 2026",
    programs: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1592285896110-8d88b5b3a5d8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    fees: "PKR 35,000 - 60,000 / sem",
    lastDate: "Aug 22, 2026",
    programs: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    fees: "PKR 80,000 - 180,000 / sem",
    lastDate: "Sep 20, 2026",
    programs: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1541339907198-e08756ebafe3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    fees: "PKR 70,000 - 120,000 / sem",
    lastDate: "Sep 08, 2026",
    programs: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    fees: "PKR 55,000 - 95,000 / sem",
    lastDate: "Sep 12, 2026",
    programs: [
...
const seedRichData = async () => {
  try {
    ...
    // Seeding (using upsert by name to keep any comments/virtuals clean)
    for (const uni of richUniversities) {
    ...
    console.log(`🌱 Successfully seeded ${richUniversities.length} premier KPK universities with HEC rankings, real images, websites, and rich programs objects.`);
